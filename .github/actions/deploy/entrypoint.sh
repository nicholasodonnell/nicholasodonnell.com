...
git clone --branch gh-pages https://$INPUT_GITHUB_TOKEN@github.com/$GITHUB_REPOSITORY.git /gh-pages
...
git push --force https://$INPUT_GITHUB_TOKEN@github.com/$GITHUB_REPOSITORY.git gh-pages
